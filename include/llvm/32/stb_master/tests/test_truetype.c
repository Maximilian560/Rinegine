...
int main(int argc, char **argv)
{
...
#if 0
   {
      ...
      stbtt__rasterize(&b, p, wcount, 1, 1, 1, 0, 0, 0, 0, 0, nullptr);
      for (i=0; i < 8; ++i)
         printf("%f\n", b.pixels[i]/255.0);
   }
#endif
...
#if 1
   {
      ...
      stbtt_PackBegin(&pc, atlas, 1024,1024,1024,1,nullptr);
