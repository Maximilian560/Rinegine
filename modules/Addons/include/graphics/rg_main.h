...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int){
  RG_Debug::addl(RG_LOG_LOCK_CRITICAL, "You are using RG_UTF but did not specify this during compilation. Please add 'utf' to your rgset file.");
  return -1;
}
...
int WINAPI wWinMain(HINSTANCE, HINSTANCE, PWSTR, int){
  RG_Debug::addl(RG_LOG_LOCK_CRITICAL, "You are not using RG_UTF, but you specified it at compile time. Please remove \"utf\" from your rgset file or define RG_UTF in the main file.");
  return -1;
}
