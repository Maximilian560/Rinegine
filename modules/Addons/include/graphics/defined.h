...
double RG_SYS_WINDOWSdow_Virtual = 2000;
double RG_SYS_WINDOWSdow_Size_Standart = RG_SYS_WINDOWSdow_Virtual;//!\\ DO NOT USING //!\\
...
RG_SYS_WINDOWSdow *RG_SYS_WINDOWSdow_Standart;
