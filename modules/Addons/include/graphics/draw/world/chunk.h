...
#define RG_HERE_FILE_NAME "graph/world-chunk"
...
//   RG_Matrix3D<RG_Block> Chunk;
//   //RG_Matrix3D<RG_WorldBlockTypes> Chunk;
//   //RG_BufObjs buf;
//   // RG_Buffer buf;
//   //RG_Matrix3D<RG_Matrix<float>>matrixs;
//   //RG_Matrix3D<POINT3D<double>>WorldBlockPosMatrix;
//   //RG_RawObject Block;
//   //RG_Object Block;
//   POINT2D<lint>pos;
...
//     cube.Load("data/objects/cube.rgobj");
...
//   return(
//     RG_Camera_StandartPtr->getMat().get(0, xyz) * pos.x * 50 +
//     RG_Camera_StandartPtr->getMat().get(1, xyz) * pos.y * 50 +
//     RG_Camera_StandartPtr->getMat().get(2, xyz) * pos.z * 50 +
//     RG_Camera_StandartPtr->getMat().get(3, xyz)
//     );
// }
...
class RG_Chunk{
  RG::vec3<uint> size={32,32,32};
  RG::vec3<uint> pos={0,0,0};
