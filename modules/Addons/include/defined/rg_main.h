...
/*#ifdef RG_SYS_WINDOWSMAIN
HINSTANCE RG_SYS_WINDOWSInstance;
HINSTANCE RG_SYS_WINDOWSPrevInstance;
//int APIENTRY WinMain(HINSTANCE instance, HINSTANCE x16instance, PWSTR inCMD, int countInCMD){
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd){
  RG_CATCH_ERROR//
    RG_SYS_WINDOWSInstance = hInstance;
    RG_SYS_WINDOWSPrevInstance = hPrevInstance;
    cout<<endl;
