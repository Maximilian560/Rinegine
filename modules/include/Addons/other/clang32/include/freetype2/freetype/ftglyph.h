...
FT_BEGIN_HEADER
   ...
   * @output:
   *   aglyph ::
   *     A handle to the glyph object.  `nullptr` in case of error.
   *
   * @return:
   *   FreeType error code.  0~means success.
   *
   ...
   * @output:
   *   target ::
   *     A handle to the target glyph object.  `nullptr` in case of error.
   *
   * @return:
   *   FreeType error code.  0~means success.
   */
...
#define ft_glyph_bbox_pixels     FT_GLYPH_BBOX_PIXELS
   ...
   * @input:
   *   glyph ::
   *     A handle to the target glyph object.  Can be `nullptr`.
   */
  FT_EXPORT( void )
