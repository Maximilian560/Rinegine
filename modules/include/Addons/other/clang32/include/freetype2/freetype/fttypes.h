...
FT_BEGIN_HEADER
   ...
   *     when the object is destroyed.  If this field is set to `nullptr`, no
   *     code will be called.
   */
...
#define FT_MAKE_TAG( _x1, _x2, _x3, _x4 )                  \
   ...
   * @fields:
   *   prev ::
   *     The previous element in the list.  `nullptr` if first.
   *
   *   next ::
   *     The next element in the list.  `nullptr` if last.
   *
   *   data ::
