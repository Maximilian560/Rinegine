...
public:
  void pre_init(double size,double maxCountNoise = 1){
    ...
    noise.random_fill(maxCountNoise);
    GradientNoise.init(size,size);
    GradientNoise.random_fill(4);
  }
