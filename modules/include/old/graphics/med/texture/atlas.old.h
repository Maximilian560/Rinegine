...
RG_Array<RG_Texture> RG_AtlasArrayTextures;
...
void RG_PreparationAtlas(RG_Array<RG_Texture> &texs = RG_AtlasArrayTextures, Atlas &atl = RG_StandartAtlas)
{
	...
	RG_FOR_CYCLEi(texs.size()){
		...
		RG_FOR_CYCLEy(texture.size.y)
		{
			RG_FOR_CYCLEx(texture.size.x)
			{
				...
				atl.textureRaw[ty][tx+0] = texture.texture[y][x*cnt+0];
				atl.textureRaw[ty][tx+1] = texture.texture[y][x*cnt+1];
				atl.textureRaw[ty][tx+2] = texture.texture[y][x*cnt+2];
				atl.textureRaw[ty][tx+3] = texture.texture[y][x*cnt+3];
				...
				if(ty>0&&y==0)
				{
					...
					atl.textureRaw[ty-1][tx+0] = texture.texture[y][x*cnt+0];
					atl.textureRaw[ty-1][tx+1] = texture.texture[y][x*cnt+1];
					atl.textureRaw[ty-1][tx+2] = texture.texture[y][x*cnt+2];
					atl.textureRaw[ty-1][tx+3] = texture.texture[y][x*cnt+3];
				...
				if(tx>0&&x==0)
				{
					...
					atl.textureRaw[ty][tx+0-1] = texture.texture[y][x*cnt+0];
					atl.textureRaw[ty][tx+1-1] = texture.texture[y][x*cnt+1];
					atl.textureRaw[ty][tx+2-1] = texture.texture[y][x*cnt+2];
					atl.textureRaw[ty][tx+3-1] = texture.texture[y][x*cnt+3];
