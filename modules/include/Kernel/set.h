...
#if defined(RG_WIN) && defined(RG_NETWORK)
#include <winsock2.h>
#include <ws2tcpip.h>
#endif

#include "defined/set.h" // Включает основные определения, используемые в
проекте
...
// #include "matrix3D.h" // Включает определения для работы с трёхмерными
матрицами
// #include "map.h"
// #include "random.h"
