...
{
   int i;
   char *binds[] = { "attr_vertex", "attr_face", nullptr };
   char *vertex;
   char *fragment;
   int w=0,h=0;

   unsigned char *texdata = stbi_load("terrain.png", &w, &h, nullptr, 4);
...

   {
      ...
      char *main_vertex[] = { vertex, nullptr };
      char *main_fragment[] = { fragment, nullptr };
